...
Report possible Code of Conduct violations to the Qbox moderation team as soon as you can.

**Discord (preferred):** Join the [Qbox Discord server](https://discord.gg/Z6Whda5hHA) and contact a moderator privately. Use the server's designated report channel if one exists, or send a direct message to a moderator or community manager. Do not discuss the incident publicly in general channels.

**GitHub:** If the violation occurred on GitHub (issues, pull requests, discussions, or comments) and you prefer not to use Discord, contact a project maintainer you trust directly. Public GitHub issues are not the right place for Code of Conduct reports.

When reporting, include:

- What happened and when (approximate date/time)
- Where it occurred (Discord channel, GitHub link, etc.)
- Who was involved (usernames)
- Screenshots, logs, or message links if you have them
- Whether you want to remain anonymous

Reports are reviewed by community moderators. We take confidentiality seriously and will not share your identity without your consent unless required for safety or legal reasons.

Community Moderators take reports of violations seriously and will make every effort to respond in a timely manner. They will investigate all reports of code of conduct violations, reviewing messages, logs, and recordings, or interviewing witnesses and other participants. Community Moderators will keep investigation and enforcement actions as transparent as possible while prioritizing safety and confidentiality. In order to honor these values, enforcement actions are carried out in private with the involved parties, but communicating to the whole community may be part of a mutually agreed upon resolution.

## Addressing and Repairing Harm

Qbox community spaces include the [Qbox Discord server](https://discord.gg/Z6Whda5hHA), all Qbox-project GitHub repositories (issues, pull requests, discussions, and comments), and other official Qbox channels.

Community Moderators may apply consequences in one or more of these spaces depending on where the violation occurred. Consequences may include a private warning, temporary restriction from community spaces (e.g. Discord timeout or mute), removal of messages or contributions, temporary ban from Discord and/or GitHub, or permanent ban from all Qbox community spaces.

Moderators may skip lower steps of the enforcement ladder for severe incidents (e.g. threats, harassment, doxxing, or hate speech).
